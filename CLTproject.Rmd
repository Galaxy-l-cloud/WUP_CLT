...
The CLT states that the sd for a sample size of 16 has changed by less than 5 integers. The mean again has remained similar to the other sample sizes. In this graph we see only one prominent peak.
